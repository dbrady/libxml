...
This version (at github) is a copy of the standard 1.1.3 version but
with all references to stderr removed. This makes libxml shut up when
running specs from other projects that use libxml.
